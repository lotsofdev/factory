...
import { TJsonSchemaFormUpdateObject, TJsonSchemaFormWidget } from '@lotsof/json-schema-form/src/shared/JsonSchemaForm.types.js';
...
export type TFactoryAdapter = {
    applyUpdate(TFactoryUpdateObject: any): void;
};
